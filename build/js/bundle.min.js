function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponisve)}function darkMode(){const e=document.querySelector(".dark-mode-boton");console.log("func"),e.addEventListener("click",(function(){document.body.classList.toggle("dark-mode")}))}function navegacionResponisve(){document.querySelector(".navegacion").classList.toggle("mostrar")}
